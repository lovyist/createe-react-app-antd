...
<div class="container">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1">
        <div class="row">
            <form method="POST" action="http://127.0.0.1:8800/edu/index/publish" accept-charset="UTF-8" enctype="multipart/form-data"><input name="_token" type="hidden" value="LFjnUdbySVcpnmNlAgJL2os30BCLQDNqYdbUutfp">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="startTime" type="time" value="10:01" id="startTime">
                </div>
                <div class="form-group">
                    <label for="endTime">结束时间</label>
                    <input class="form-control" name="endTime" type="time" value="10:01" id="endTime">
                </div>
